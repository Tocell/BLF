...
* \return TRUE on success, otherwise FALSE
*/
BLAPI(int32_t)  BLSetMeasurementStartTime2(BLHANDLE hFile, const LPSYSTEMTIME lpStartTime, uint32_t startTimeNs, uint8_t timezoneInfoValid, int16_t utcOffset, uint8_t isDST);
/**
